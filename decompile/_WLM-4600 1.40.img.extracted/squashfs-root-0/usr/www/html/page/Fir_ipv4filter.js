...
function uiSubmit(){
	var WanFilterNum = Number(Form.Radio('RAD_wanTolan')) + 3;
	...
	$H({
		':InternetGatewayDevice.X_TWSZ-COM_Firewall.IPFilterEnable'			: Form.Checkbox('CHE_ipfilter'),
        ':InternetGatewayDevice.X_TWSZ-COM_Firewall.SPIEnable'              : Form.Checkbox('INPUT_SPI'),
		':InternetGatewayDevice.X_TWSZ-COM_Firewall.SecurityLevel' 			: $('SEL_SecurLevel').value,
